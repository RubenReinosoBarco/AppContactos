...
class Nuevo : AppCompatActivity() {
    ...
    val fotos = arrayListOf(R.drawable.foto_01,R.drawable.foto_02,R.drawable.foto_03,R.drawable.foto_04,R.drawable.foto_05,R.drawable.foto_06)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Reconocer acción nuevo vs editar
    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        when(item?.itemId){
            ...
            R.id.iCrearNuevo->{
                // Crear un nuevo elemento de tipo contactos
